...
INSERT INTO Address VALUES (8156, 'W 31st Ave', (SELECT PostalCode FROM AddressPostalCode WHERE PostalCode = 'V6L 3K8'));
INSERT INTO Address VALUES (641, '17st Ave SW', (SELECT PostalCode FROM AddressPostalCode WHERE PostalCode = 'T2S 0B5'));
INSERT INTO Address VALUES (47159, 'Danforth Ave', (SELECT PostalCode FROM AddressPostalCode WHERE PostalCode = 'M4C 1K7'));
...
INSERT INTO Address VALUES (47158, 'Main Mall', (SELECT PostalCode FROM AddressPostalCode WHERE PostalCode = 'V6T 1Z4'));
